...
function tgl_indo2($tunggulin, $jenis = "")
{
	if (empty($jenis)) {
		$belendung = array(
			1 =>   'Januari',
...
function sambutan($data)
{
	...
	if ($hour >= 0 && $hour <= 2) {
		...
		$pesanane	= "Selamat subuh";
	} else if ($hour >= 6 && $hour <= 9) {
		$pesanane	= "Selamat pagi";
	} else if ($hour >= 10 && $hour <= 11) {
		$pesanane	= "Selamat pagi menjelang siang";
	} else if ($hour >= 12 && $hour <= 14) {
		$pesanane	= "Selamat siang";
	} else if ($hour == 15) {
		$pesanane	= "Selamat siang menjelang sore";
	} else if ($hour >= 16 && $hour <= 17) {
		$pesanane	= "Selamat sore";
	} else if ($hour >= 18 && $hour <= 19) {
		$pesanane	= "Selamat petang";
