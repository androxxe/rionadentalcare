...
<?php
	...
	$spasi = $this->db->query("SELECT a.*, b.`jenis_kelamin` FROM booking a LEFT JOIN pasien b ON a.`id_pasien` = b.`id_pasien` LEFT JOIN dokter c ON a.`id_dokter` = c.`id_dokter` WHERE a.`jenis` = 'terdaftar' AND a.id_booking = '".$id_booking."'");
									...
									<form method="post" class="row formulir_tambah">
										...
										<div class="col-md-6">
												...
												<div class="form-group">
													<label class="font-weight-bold text-uppercase">ID. Pasien :</label>
													<div class="input-group">
														<input type="text" class="form-control" name="id_pasien_sample" id="id_pasien_tambah" placeholder="ID. Pasien" readonly="readonly" value="<?= $dpasi[0]['id_pasien']." - ".$dpasi[0]['nama_pasien'] ?>" required>
														<div class="input-group-append">
															<a class="btn btn-outline bg-indigo-400 text-indigo-400 border-indigo-400 legitRipple" data-toggle="modal" data-target="#modalCariPasien">CARI </a>
														</div>
													</div>
												...
												<div class="form-group" id="f_kelamin">
													<label>Jns. Kelamin :</label>
													<input type="text" class="form-control" name="kelamin" value="<?= $jk ?>" id="kelamin_tambah" placeholder="Jns. Kelamin" readonly="readonly" required>
												</div>
												<div class="form-group" id="f_telp">
													<label>No. Telp :</label>
