											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>Tanggal :</label>
														<div class="form-group form-group-feedback form-group-feedback-left">
															<input type="text" class="form-control tanggal_booking" value="<?= $dpasi[0]['tanggal_booking'] ?>" id="tanggal_booking" placeholder="Tanggal Booking" name="tanggal_booking" required>
															<div class="form-control-feedback form-control-feedback-sm">
																<i class="icon-calendar"></i>
															</div>
														</div>
