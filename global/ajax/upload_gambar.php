...
if (is_uploaded_file($temp['tmp_name'])) {
    ...
    $fileName = "http://localhost/rekreatif/berkas/artikel/" . $temp['name'];
    $fileURL =  "http://localhost/rekreatif/berkas/artikel/" . $temp['name'];
    move_uploaded_file($temp['tmp_name'], $fileName);


    echo json_encode(array('file_path' => $fileURL));
}
